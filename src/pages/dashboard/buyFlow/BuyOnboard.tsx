...
const BuyOnboard = ({ setBuyType, setBuyModal, setSelectCoinModal }: any) => {
  return (
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h4 className="text-gray-500 mt-1 dark:text-gray-400 text-[12px]">
                    Buy crypto into your celler wallet
                  </h4>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h4 className="text-gray-500 mt-1 dark:text-gray-400 text-[12px]">
                    Buy crypto to your external wallets
                  </h4>
                </div>
              </div>
              <SlArrowRight className="text-gray-400 dark:text-gray-200 text-[15px]" />
