...
import { btc, eth, bnb, trx, solana } from "../../../assets/images";
        ...
        <div className="w-full mt-8">
          ...
          <div className="w-full mt-6">
            {coins?.cryptocurrencies
              .filter(
                (coin: any) => coin.symbol === withdrawcoindeets.crypto_symbol
              )[0]
